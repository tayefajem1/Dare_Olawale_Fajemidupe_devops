...
touch name.csv id_rsa id_rsa.pem
### In names.csv put name
vi names.csv
Ola
Junior
Becham
...
Aliyu
Seun
### Open id_rsa.pem copy and paste the key below
vi id_rsa.pem
...
###  Open id_rsa copy and paste the key below
...
sudo passwd -x 5 $user
  ...
  ### Open onboard.sh again and paste the below
  /home/ubuntu/Shell 
  We need to create and set public key for users in the server
 ...
 sudo groupadd developers
  chmod +x onboard.sh
  ### run the script without sudo prevelege
  ./onboard.sh
  ### switch to super user
  sudo su
 ### run  the script again
 ./onboard.sh
 ### run the command to see if the developers is created
